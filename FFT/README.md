...
$\{\mathbf{x}_n\} \coloneqq x_0, x_1, \ldots, x_{N-1}$

<!-- $\{\mathbf{x}_n\}\coloneqq x_0, x_1, \ldots,x_{N-1}$ në një varg tjetër numrash kompleks:
$\{\mathbf{X}_k \} \coloneqq X_0,X_1,\ldots,X_{N-1}$, e cila definohet nga formula: -->
